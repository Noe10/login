...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h3 style="text-align: left; margin-left:10% ; margin-top: 3%;">Deposito</h3>
      <div class="container">
              ...
              <div class="card-body">
                ...
                <form id="task-form" >
                  <div class="form-group">
                    <input type="text" id="fecha" placeholder="Fecha Deposito" class="form-control">
                  </div>
                  <div class="form-group">
                    <input id="monto" cols="30" rows="10" class="form-control" placeholder="Monto Deposito"></input>
                  </div>
                  <div class="form-group">
      ...
      <!-- Frontend Logic -->
      <script src="deposito/procesosDeposito.js"></script>
</body>
</html>